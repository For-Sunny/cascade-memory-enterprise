...
CASCADE Memory was built with security as a core requirement, not an afterthought. The codebase includes:
...
If you discover a security vulnerability in CASCADE Memory, please report it privately.
...
**Subject Line**: [SECURITY] CASCADE Vulnerability Report
...
For detailed documentation of CASCADE's security features, see the [Security Features](README.md#security-features) section of the README.
